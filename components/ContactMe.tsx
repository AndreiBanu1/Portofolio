...
function ContactMe() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-5 text-center items-center mt-20 lg:mt-0">
        ...
        <div className="space-y-0 md:space-y-10">
          <div className="flex items-center space-x-5">
            ...
            <p className="text-sm md:text-2xl">WhatsApp: +40720421884</p>
          </div>

          <div className="flex items-center space-x-5 ">
            <EnvelopeIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-sm md:text-2xl">andreibanu97@yahoo.com</p>
          </div>

          <div className="flex items-center space-x-5 ">
            <MapPinIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-sm md:text-2xl">Bucharest, Romania</p>
          </div>
